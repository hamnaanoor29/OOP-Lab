...
public class ProductDemo {
    ...
    /*    System.out.println(p1);
       System.out.println(p2);
        ...
        p10.setBrand("Paktel");
       // Product p11 =new Product(p10.getName().equals.p13.getName(),p10.getBrand().equals.p13.getBrand(),p10.getCategory().equals.p13.getCategory(),p10.getPrice()==p13.getPrice(),p10.getQuantity()==p13.getQuantity(),p10.getWarrantyMonths()==p13.getWarrantyMonths());
