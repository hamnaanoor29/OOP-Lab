...
public class Product {
    ...
    public boolean equals(Product other){
        if(this.name.equals(other.name) && this.id.equals(other.id) && this.brand.equals(other.brand) && this.category.equals (other.category) && this.price==(other.price) && this.quantity==(other.quantity) && this.warrantyMonths==(other.warrantyMonths))
            return true;
        else
            return false;
    }
